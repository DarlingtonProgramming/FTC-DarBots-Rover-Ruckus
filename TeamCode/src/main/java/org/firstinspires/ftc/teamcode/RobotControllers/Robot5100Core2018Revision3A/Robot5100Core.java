...
public class Robot5100Core implements RobotNonBlockingDevice,RobotEventLoopable {
    ...
    public Robot5100Core(@NonNull OpMode ControllingOpMode, double initialX, double initialY, double initialRotation, double linearActuatorPos){
        ...
        this.m_ColorSensor = ControllingOpMode.hardwareMap.colorSensor.get(Robot5100Setting.COLORSENSOR_CONFIGURATIONNAME);
    ...
    public void doLoop() {
        ...
        RobotDebugger.addDebug("ColorSensor","ARGB(" + this.m_ColorSensor.alpha() + "," + this.m_ColorSensor.red() + "," + this.m_ColorSensor.green() + "," + this.m_ColorSensor.blue() + ")");
