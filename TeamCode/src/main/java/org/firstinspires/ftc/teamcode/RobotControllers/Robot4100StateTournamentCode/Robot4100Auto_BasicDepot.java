...
public class Robot4100Auto_BasicDepot extends Robot4100Auto_OffHook {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(this.opModeIsActive()){
            ...
            this.m_RobotCore.getMotionSystem().addTask(this.m_RobotCore.getMotionSystem().getFixedZDistanceTask(-65,Robot4100Setting.AUTONOMOUS_BIGGESTDRIVINGSPEED));
            this.m_RobotCore.getMotionSystem().waitUntilFinish();
            this.m_RobotCore.getGyro().updateData();
            tempAng = this.m_RobotCore.getGyro().getHeading();
            this.m_RobotCore.getMotionSystem().addTask(this.m_RobotCore.getMotionSystem().getFixedTurnTask(XYPlaneCalculations.normalizeDeg(-(tempAng-startAng)),0.1));
            ...
            this.m_RobotCore.goRightToWall(0.2,0.3);
            ...
            m_RobotCore.getMotionSystem().addTask(m_RobotCore.getMotionSystem().getFixedZDistanceTask(160,0.1));
