...
public class Robot4100AutoTest extends LinearOpMode {
    ...
    protected void offHookAndDetectSample(){
        ...
        this.m_RobotCore.getMotionSystem().replaceTask(this.m_RobotCore.getMotionSystem().getFixedXDistanceTask(-15,Robot4100Setting.AUTONOMOUS_BIGGESTDRIVINGSPEED));
        ...
        if(infos == null || infos.length != 2){
            m_GoldPosition = FTC2018GameSpecificFunctions.GoldPosType.Unknown;
        }else{
